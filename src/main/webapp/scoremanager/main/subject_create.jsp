...
<c:import url="/common/base.jsp">
	...
	<c:param name="content">
		...
		<form action="SubjectCreateExecute.action" method="post">
			...
			<input class="form-control mb-2" id="subject-cd-input" type="text" name="cd" value="${cd}" 
			...
			<input class="form-control mb-3" id="subject-name-input" type="text" name="name" value="${name}"
				placeholder="科目名を入力してください" required>
			<button class="btn btn-primary mb-3" id="end-button" type="submit">登録</button>
		</form>
